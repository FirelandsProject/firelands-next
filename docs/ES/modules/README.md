# Índice de módulos (ES)

Lectura recomendada:

| Orden | Módulo | Archivo |
|-------|--------|---------|
| 1 | Shared (`src/shared`) | [shared.md](shared.md) |
| 2 | Domain (`src/domain`) | [domain.md](domain.md) |
| 3 | Application (`src/application`) | [application.md](application.md) |
