...
enum WorldOpcode : uint32 {
  ...
  /// Reference: cata-ref `SMSG_LOG_XP_GAIN` — on-screen XP floater + combat log line.
  ...
  /// Quest map POI blobs (client after accepting / tracking quests).
  CMSG_QUEST_POI_QUERY = 0x4037,
  SMSG_QUEST_POI_QUERY_RESPONSE = 0x6304,
  /// Quest giver / objective NPC entries for world map markers.
